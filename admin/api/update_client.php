...
if ($isPaymentOnly) {
    ...
    $stmt->bind_param("sssssssssdddi", $addressStreet, $addressLine2, $addressCity, $addressCounty, $addressPostcode, $addressCountry, $leadSource, $servicesJson, $totalCost, $totalPaid, $totalRemaining, $clientId);
}
